			...
			<div class="container w3-center"
				...
				<div class="w3-row-padding w3-padding-large w3-center"
					...
					<%
						...
						String sqlPhotoId = "select photoid,description from photo where userid=" + user.getUserId();
						String sqlKeyword = "select k.keyword from tagged_keywords k inner join photo_keyword_map map on map.keywordid=k.keywordid where map.photoid=?";
						ResultSet result;
						try {

							photoId = service.selectPhotoIdByUserId(user.getUserId());
							description = service.selectDescriptionByUserId(user.getUserId());
							//	PreparedStatement stmtKeyword = con.prepareStatement(sqlKeyword);
					...
					<div
						...
						<a href="DetailPhoto?photoid=<%=photoId.get(i)%>"
							...
							<tr>
								<%
									List<String> keywords = new ArrayList<String>();
											keywords = service.selectKeywordByPhotoId(photoId.get(i));
						...
						<a href="DeletePhoto?photoid=<%=photoId.get(i)%>" onclick="return confirm('Do you want to delete this photo?')"><i
